  ...
  return `
        <div class="card reveal section">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item"><span class="feature-title">全架构兼容</span><span class="feature-desc">完美支持 macOS Intel (x86_64) 和 Apple Silicon (M1/M2/M3/M4) 芯片。</span></div>
        ...
        <div class="grid-1-1">
            <div class="card reveal">
                ...
                <div class="steps">
                    ...
                    <div class="step"><div class="step-title">生效配置</div><p class="step-desc">安装完成后，执行 <code>source ~/.zshrc</code> 或重启终端即可使用。</p></div>
                </div>
            </div>
            <div class="card reveal">
